...
public class AgentClientRpcDecoder extends ByteToMessageDecoder {
    @Override
    ...
    private Object decode2(ByteBuf byteBuf) {
        ...
        AgentResponse rpcResponse = new AgentResponse();
        rpcResponse.setRequestId(String.valueOf(Bytes.bytes2long(Arrays.copyOfRange(data, 0, 8), 0)));
        rpcResponse.setBytes(Arrays.copyOfRange(data, 12, tt));
        return rpcResponse;
    }
